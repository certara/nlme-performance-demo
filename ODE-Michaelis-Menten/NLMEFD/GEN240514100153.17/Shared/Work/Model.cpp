...
static double __CMultStdev_low  = 3.3e-151;
static double __CMultStdev_init = 0.4645188276447870246;
static double __CMultStdev_high = 3.3e-151;
static double __tvVmax_low  = 3.3e-151;
static double __tvVmax_init = 2008.823066731579956;
static double __tvVmax_high = 3.3e-151;
static double __tvKm_low  = 3.3e-151;
static double __tvKm_init = 2991.604055571090157;
static double __tvKm_high = 3.3e-151;
static double __tvV_low  = 3.3e-151;
static double __tvV_init = 7.894565146092969776;
static double __tvV_high = 3.3e-151;
static double __tvKa_low  = 3.3e-151;
static double __tvKa_init = 0.3965523515834240009;
static double __tvKa_high = 3.3e-151;
static double __K12_low  = 3.3e-151;
static double __K12_init = 0.9541992301815600541;
static double __K12_high = 3.3e-151;
static double __K21_low  = 3.3e-151;
static double __K21_init = 0.5570824634640969553;
static double __K21_high = 3.3e-151;
void RestoreFixefLowInitHighFromModel(){
	__CMultStdev_low  = 3.3e-151;
	__CMultStdev_init = 0.4645188276447870246;
	__CMultStdev_high = 3.3e-151;
	__tvVmax_low  = 3.3e-151;
	__tvVmax_init = 2008.823066731579956;
	__tvVmax_high = 3.3e-151;
	__tvKm_low  = 3.3e-151;
	__tvKm_init = 2991.604055571090157;
	__tvKm_high = 3.3e-151;
	__tvV_low  = 3.3e-151;
	__tvV_init = 7.894565146092969776;
	__tvV_high = 3.3e-151;
	__tvKa_low  = 3.3e-151;
	__tvKa_init = 0.3965523515834240009;
	__tvKa_high = 3.3e-151;
	__K12_low  = 3.3e-151;
	__K12_init = 0.9541992301815600541;
	__K12_high = 3.3e-151;
	__K21_low  = 3.3e-151;
	__K21_init = 0.5570824634640969553;
	__K21_high = 3.3e-151;
}
...
void GetInitialOmega5(double* _omat){
	...
	_omat[0+0+0*4] = 1.966952699999999915e-05;
	_omat[0+1+1*4] = 0.1784634599999999904;
	_omat[0+2+2*4] = 0.4837028899999999965;
	_omat[0+3+3*4] = 0.3030054999999999832;
}
...
double GetEtaVariance5(int _i){
	...
	if (0){
		...
		_temp = 1.966952699999999915e-05;
	} else if (_i == 1){
		_temp = 0.1784634599999999904;
	} else if (_i == 2){
		_temp = 0.4837028899999999965;
	} else if (_i == 3){
		_temp = 0.3030054999999999832;
	}
	return _temp;
}
