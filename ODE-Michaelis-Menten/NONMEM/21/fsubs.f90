      ...
      REAL(KIND=DPSIZE), POINTER ::TVKA,KA,K23,K32,SC,Y,CONC,A000032
      REAL(KIND=DPSIZE), POINTER ::A000034,A000036,A000037,D000001
      REAL(KIND=DPSIZE), POINTER ::D000002,D000003,D000036,D000035
      REAL(KIND=DPSIZE), POINTER ::D000034,C000033,C000032,D000039
      REAL(KIND=DPSIZE), POINTER ::D000038,D000037,A000038,A000039
      REAL(KIND=DPSIZE), POINTER ::A000040,E000006,F000082,E000008
      REAL(KIND=DPSIZE), POINTER ::E000011,E000012,F000088,F000085
      REAL(KIND=DPSIZE), POINTER ::F000089,F000086,F000090,F000091
      REAL(KIND=DPSIZE), POINTER ::E000014,E000015,F000093,F000094
      CONTAINS
      ...
      K23=>COM(000010);K32=>COM(000011);SC=>COM(000012);Y=>COM(000013)
      CONC=>COM(000014);A000032=>COM(000015);A000034=>COM(000016)
      A000036=>COM(000017);A000037=>COM(000018);D000001=>COM(000019)
      D000002=>COM(000020);D000003=>COM(000021);D000036=>COM(000022)
      D000035=>COM(000023);D000034=>COM(000024);C000033=>COM(000025)
      C000032=>COM(000026);D000039=>COM(000027);D000038=>COM(000028)
      D000037=>COM(000029);A000038=>COM(000030);A000039=>COM(000031)
      A000040=>COM(000032);E000006=>COM(000033);F000082=>COM(000034)
      E000008=>COM(000035);E000011=>COM(000036);E000012=>COM(000037)
      F000088=>COM(000038);F000085=>COM(000039);F000089=>COM(000040)
      F000086=>COM(000041);F000090=>COM(000042);F000091=>COM(000043)
      E000014=>COM(000044);E000015=>COM(000045);F000093=>COM(000046)
      F000094=>COM(000047)
 ...
 !  level            0
      ...
      KM=TVKM*B000003 
      IF(CWT == 0.D0.AND.THETA(005) <= 0.D0)THEN 
      IERPRD=1
...
!                      C000033 = DERIVATIVE OF Y W.R.T. EPS(001)
      C000033=1.D0 
      IF (FIRSTEM == 1) THEN !1
!                      D000034 = DERIVATIVE OF Y W.R.T. ETA(003)
      D000034=B000001*D000003 
!                      D000035 = DERIVATIVE OF Y W.R.T. ETA(002)
      D000035=B000001*D000002 
!                      D000036 = DERIVATIVE OF Y W.R.T. ETA(001)
      D000036=B000001*D000001 
!                      D000037 = DERIVATIVE OF C000032 W.R.T. ETA(003)
      D000037=B000001*D000003 
!                      D000038 = DERIVATIVE OF C000032 W.R.T. ETA(002)
      D000038=B000001*D000002 
!                      D000039 = DERIVATIVE OF C000032 W.R.T. ETA(001)
 ...
 !  level            0
      ...
      DADT(1)=-P(002)*A(1) 
      B000003=P(003)+CONC 
      DADT(2)=P(002)*A(1)-P(004)*CONC/B000003-P(005)*A(2)+P(006)*A(3) 
...
!                      F000089 = DERIVATIVE OF DADT(2) W.R.T. P(003)
      F000089=B000009 
!                      F000090 = DERIVATIVE OF DADT(2) W.R.T. P(005)
      F000090=-A(2) 
!                      F000091 = DERIVATIVE OF DADT(2) W.R.T. P(006)
      F000091=A(3) 
!                      E000014 = DERIVATIVE OF DADT(3) W.R.T. A(002)
      E000014=P(005) 
!                      E000015 = DERIVATIVE OF DADT(3) W.R.T. A(003)
      E000015=-P(006) 
!                      F000093 = DERIVATIVE OF DADT(3) W.R.T. P(005)
      F000093=A(2) 
!                      F000094 = DERIVATIVE OF DADT(3) W.R.T. P(006)
      F000094=-A(3) 
      ENDIF !1
      IF (FIRSTEM == 1) THEN !2
      DA(   1,1)=E000006
      ...
      NAME_FSIZES(29)='PIR'; F_SIZES(29)=10
