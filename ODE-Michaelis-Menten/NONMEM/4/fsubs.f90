      ...
      REAL(KIND=DPSIZE), POINTER ::A000036,A000038,A000039,D000001
      REAL(KIND=DPSIZE), POINTER ::D000002,D000003,D000004,D000038
      REAL(KIND=DPSIZE), POINTER ::D000037,D000036,D000035,C000033
      REAL(KIND=DPSIZE), POINTER ::C000032,D000042,D000041,D000040
      REAL(KIND=DPSIZE), POINTER ::D000039,A000040,A000041,A000042
      REAL(KIND=DPSIZE), POINTER ::A000043,E000005,F000082,E000007
      REAL(KIND=DPSIZE), POINTER ::E000009,F000088,F000085,F000089
      REAL(KIND=DPSIZE), POINTER ::F000086
      CONTAINS
      ...
      A000032=>COM(000013);A000034=>COM(000014);A000036=>COM(000015)
      A000038=>COM(000016);A000039=>COM(000017);D000001=>COM(000018)
      D000002=>COM(000019);D000003=>COM(000020);D000004=>COM(000021)
      D000038=>COM(000022);D000037=>COM(000023);D000036=>COM(000024)
      D000035=>COM(000025);C000033=>COM(000026);C000032=>COM(000027)
      D000042=>COM(000028);D000041=>COM(000029);D000040=>COM(000030)
      D000039=>COM(000031);A000040=>COM(000032);A000041=>COM(000033)
      A000042=>COM(000034);A000043=>COM(000035);E000005=>COM(000036)
      F000082=>COM(000037);E000007=>COM(000038);E000009=>COM(000039)
      F000088=>COM(000040);F000085=>COM(000041);F000089=>COM(000042)
      F000086=>COM(000043)
...
!                      A000038 = DERIVATIVE OF KA W.R.T. ETA(004)
      A000038=TVKA*B000007 
!                      A000039 = DERIVATIVE OF SC W.R.T. ETA(003)
      A000039=A000036 
!                      A000040 = DERIVATIVE OF P000001 W.R.T. ETA(003)
      A000040=A000039 
!                      A000041 = DERIVATIVE OF P000002 W.R.T. ETA(004)
      A000041=A000038 
!                      A000042 = DERIVATIVE OF P000003 W.R.T. ETA(002)
      A000042=A000034 
!                      A000043 = DERIVATIVE OF P000004 W.R.T. ETA(001)
      ...
      GG(0002,1,1)=P000002
      GG(0002,0005,1)=A000041
      GG(0003,1,1)=P000003
      GG(0003,0003,1)=A000042
      GG(0004,1,1)=P000004
      GG(0004,0002,1)=A000043
      GG(0005,1,1)=SC
      GG(0005,0004,1)=A000039
      ELSE
      GG(0001,1,1)=P000001
      GG(0002,1,1)=P000002
      GG(0003,1,1)=P000003
...
!                      C000033 = DERIVATIVE OF Y W.R.T. EPS(001)
      C000033=1.D0 
      IF (FIRSTEM == 1) THEN !1
!                      D000035 = DERIVATIVE OF Y W.R.T. ETA(004)
      D000035=B000001*D000004 
!                      D000036 = DERIVATIVE OF Y W.R.T. ETA(003)
      D000036=B000001*D000003 
!                      D000037 = DERIVATIVE OF Y W.R.T. ETA(002)
      D000037=B000001*D000002 
!                      D000038 = DERIVATIVE OF Y W.R.T. ETA(001)
      D000038=B000001*D000001 
!                      D000039 = DERIVATIVE OF C000032 W.R.T. ETA(004)
      D000039=B000001*D000004 
