      ...
      REAL(KIND=DPSIZE), POINTER ::D000001,D000032,C000033,C000032
      REAL(KIND=DPSIZE), POINTER ::D000033,A000033,E000006,F000082
      REAL(KIND=DPSIZE), POINTER ::E000008,E000011,E000012,F000088
      REAL(KIND=DPSIZE), POINTER ::F000085,F000089,F000086,F000090
      REAL(KIND=DPSIZE), POINTER ::F000091,E000014,E000015,F000093
      REAL(KIND=DPSIZE), POINTER ::F000094
      CONTAINS
      ...
      CONC=>COM(000014);A000032=>COM(000015);D000001=>COM(000016)
      D000032=>COM(000017);C000033=>COM(000018);C000032=>COM(000019)
      D000033=>COM(000020);A000033=>COM(000021);E000006=>COM(000022)
      F000082=>COM(000023);E000008=>COM(000024);E000011=>COM(000025)
      E000012=>COM(000026);F000088=>COM(000027);F000085=>COM(000028)
      F000089=>COM(000029);F000086=>COM(000030);F000090=>COM(000031)
      F000091=>COM(000032);E000014=>COM(000033);E000015=>COM(000034)
      F000093=>COM(000035);F000094=>COM(000036)
...
!                      A000033 = DERIVATIVE OF P000004 W.R.T. ETA(001)
      A000033=A000032 
      GG(0001,1,1)=P000001
      GG(0002,1,1)=P000002
      GG(0003,1,1)=P000003
      GG(0004,1,1)=P000004
      GG(0004,0002,1)=A000033
      GG(0005,1,1)=P000005
      GG(0006,1,1)=P000006
      GG(0007,1,1)=SC
      ELSE
...
!                      C000033 = DERIVATIVE OF Y W.R.T. EPS(001)
      C000033=1.D0 
      IF (FIRSTEM == 1) THEN !1
!                      D000032 = DERIVATIVE OF Y W.R.T. ETA(001)
      D000032=B000001*D000001 
!                      D000033 = DERIVATIVE OF C000032 W.R.T. ETA(001)
      D000033=B000001*D000001 
      G(001,1)=D000032
      ENDIF !1
      HH(001,1)=C000033
      HH(002,1)=C000032
...
!                      F000094 = DERIVATIVE OF DADT(3) W.R.T. P(006)
      ...
      NAME_FSIZES(36)='MAXOMEG'; F_SIZES(36)=1
      ...
      NAME_FSIZES(47)='NOMEG'; F_SIZES(47)=1
