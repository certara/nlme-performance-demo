      ...
      REAL(KIND=DPSIZE), POINTER ::TVKA,KA,SC,REP,IPRED,Y,CONC,A000032
      REAL(KIND=DPSIZE), POINTER ::D000001,D000033,C000033,C000032
      REAL(KIND=DPSIZE), POINTER ::D000034,A000033,E000005,F000082
      REAL(KIND=DPSIZE), POINTER ::E000007,E000009,F000088,F000085
      REAL(KIND=DPSIZE), POINTER ::F000089,F000086
      CONTAINS
      ...
      SC=>COM(000010);REP=>COM(000011);IPRED=>COM(000012)
      Y=>COM(000013);CONC=>COM(000014);A000032=>COM(000015)
      D000001=>COM(000016);D000033=>COM(000017);C000033=>COM(000018)
      C000032=>COM(000019);D000034=>COM(000020);A000033=>COM(000021)
      E000005=>COM(000022);F000082=>COM(000023);E000007=>COM(000024)
      E000009=>COM(000025);F000088=>COM(000026);F000085=>COM(000027)
      F000089=>COM(000028);F000086=>COM(000029)
...
!                      C000033 = DERIVATIVE OF Y W.R.T. EPS(001)
      C000033=1.D0 
      IF (FIRSTEM == 1) THEN !1
!                      D000033 = DERIVATIVE OF Y W.R.T. ETA(001)
      D000033=B000001*D000001 
!                      D000034 = DERIVATIVE OF C000032 W.R.T. ETA(001)
...
!                      F000089 = DERIVATIVE OF DADT(2) W.R.T. P(003)
      ...
      NAME_FSIZES(43)='PDT'; F_SIZES(43)=7
